...
procedure leerProducto(var datos:producto);
...
procedure actualizarStock(var a:archivo_maestro; var detalles:arreglo_detalle);
var
	i:integer;
	min:actualizacion;
	regm:producto;
...
begin
	...
	leerDetalles(arreglo); {creo los N detalles}
	assign(txt, 'noStock.txt');
	actualizarStock(maestro,arreglo);
